<div class="container-fluid" style="height: 100vh; background: #faaC1D;">
    <div class="row justify-content-center">
        <div class="col-11 col-lg-4 col-md-4 bg-white text-center p-5" style="border-radius: 25px; margin-top: 100px;">
            <img src="<?=base_url()?>resources/img/logo.png" alt="" style="width: 80%">
            ...
            <form action="<?=base_url()?>login" method="POST">
                ...
                <button class="btn text-white w-100" style="background: #D33C2D;" type="submit">Login</button>
            </form>    
        </div>
    </div>
</div>